...
//
// Usage: node scripts/wasm_smoke_test.mjs target/wheels/dot_explorer-*.whl
//
...
// imports dot_explorer, and runs a tiny k-mer comparison through the Rust core.
...
// matplotlib/numpy are imported by dot_explorer's __init__; load the prebuilt
...
idx = dot_explorer.SequenceIndex(8)
...
print('dot_explorer wasm OK:', len(matches), 'match blocks')
`);
